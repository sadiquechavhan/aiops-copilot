...
# Find where to append - after the S6 hybrid search entry (entry 145)
# The file ends with the S6 hybrid search entry
if "Session 7" not in eng_content:
    ...
    with open(r'c:\Users\sadiq\Downloads\New_Project\ENGINEERING_LOG.md', 'w', encoding='utf-8') as f:
        f.write(eng_content)
    print("✓ ENGINEERING_LOG.md updated with Session 7 entries")
else:
    print("✓ ENGINEERING_LOG.md already has Session 7")
